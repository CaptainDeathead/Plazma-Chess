...
def main():
    ...
    move_dot = pygame.image.load("Sprites/Moves Circle.png").convert_alpha()
    selected_piece = None

    # load the pieces sprites
    pieces = []
    for i in range(len(pieces_sprites)):
        pieces.append(pygame.image.load(pieces_sprites[i]).convert_alpha())
